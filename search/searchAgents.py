        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not self.walls[nextx][nexty]:
                ...
                for i, corner in enumerate(self.corners):
                    if nextPosition == corner and not newVisitedCorners[i]:
                        newVisitedCorners[i] = True
                        break
                successorState = (nextPosition, tuple(newVisitedCorners))
...
def cornersHeuristic(state: Any, problem: CornersProblem):
    ...
    permutations = itertools.permutations(unvisited_corners)
...
def foodHeuristic(state: Tuple[Tuple, List[List]], problem: FoodSearchProblem):
    ...
    return max([mazeDistance(pacmanPosition, food, problem.startingGameState) for food in foodPositions] + [0])
